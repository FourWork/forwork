 ...
 <div class="column_left" style="width:40%">
	<%-- <c:forEach var="portfolio" items="${list }"> --%>
			<div class="alert alert-primary" role="alert" style="width:100%">
  				<h4 class="alert-heading">[Portfoloio title]</h4>
				...
				<button type="button" class="btn btn-outline-secondary">삭제</button>
  				<p><table align="center" style="width:100%">
					...
					<tr>
						<p>
						<td colspan="4">[portfolio-detail]</td>
						<p>
					</tr>
					</table>
				</p>
  				...
  				<p class="mb-0">
  					<%-- <c:forEach var="portfolio_language"	items="${langList }"> --%>
						...
						<span class="badge badge-pill badge-primary">[portfoliolanguage]</span>
						<%-- </c:if> --%>
					<%-- </c:forEach> --%></p>
				</div>
			</div>
				...
				<div class="card card-profile">
					...
					<div class="card-body">
						...
						<div class="text-center" style="padding-top:100px;">
							<h5 class="h3">
								[member_name]<span class="font-weight-light">, 27</span>
							</h5>
							<div class="h5 mt-4">
								<i class="ni business_briefcase-24 mr-2"></i>[member_email]
							</div>
							<div>
