	...
	function showList(){
		...
		taskService.listTask(function(list){
			...
			for(var i =0, len=list.length ; i < len ; i++){
				var part2="</p><div class='dropdown float-right'><a class='btn btn-default' href='#' role='button' id='dropdownMenuLink' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'> ... </a><div class='dropdown-menu' aria-labelledby='dropdownMenuLink'><a class='dropdown-item addRes' href='#'>담당자 추가</a><a id='sendTodoA"+list[i].task_id+"' data-task_id="+list[i].task_id+" class='dropdown-item' href='#'>To-do List에 추가</a><a class='dropdown-item' href='#' id='taskEdit' data-task_id='";
				var log = "";
				//log값 가져오기
				log = function(){
					var str ="";
