...
$(document).ready(function(){
	...
	console.log("제목!!"+formInputTitle.val());
	...
	$("#PortfolioSubmit").click(function(){
		...
		//for portfolioService add 
		 portfolioService.add({
			portfolio: { 
		        "portfolio_title":formInputTitle.val(),
		        "portfolio_detail":formInputDetail.val(),
		        "portfolio_start_date":formInputStartDate.val(),
		        "portfolio_end_date":formInputEndDate.val(),
		        },
